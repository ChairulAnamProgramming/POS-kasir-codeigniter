 <?php 
  ...
  $queryMenu =  "SELECT `user_menu`.`id`,`menu`,`icon`
                  ...
                  $toko = $this->db->get('outlet')->row_array();
  ?>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?= base_url(); ?>" class="site_title"><i class="fa fa-laptop"></i> <span><?= $toko['nama_toko'] ?></span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h3>General</h3>
                  ...
                  <li><a href="<?= base_url('Sales'); ?>"><i  class="fa fa-cubes"></i>Kasir</a></li>
                  ...
                  <li><a><i class="fa fa-database"></i>Master Data<span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                         ...
                         <li><a href="<?= base_url('Data/pembelian'); ?>">Pembelian Barang</a></li>
                         <li><a href="<?= base_url('Data/catagory'); ?>">Catagory</a></li>
                         <li><a href="<?= base_url('Data/merek'); ?>">Merek</a></li>
                         <li><a href="<?= base_url('Data/customer'); ?>">Customer</a></li>
                      </ul>
                  </li>


                  <li><a><i class="fa fa-print"></i>Transaksi<span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                         <li><a href="<?= base_url('Laporan'); ?>">Penjualan</a></li>
                         <li><a href="<?= base_url('Laporan/pembell'); ?>">Seluruh Pembeli</a></li>
                      </ul>
                  </li>

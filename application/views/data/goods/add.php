                    ...
                    <form id="demo-form2" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="kode_barang"  name="kode_barang" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_group form-control" name="catagory" id="catagory" onchange="myData()">
                              ...
                              <?php foreach ($catagory as $cat): ?>
                                <option value="<?= $cat['nama_catagory'] ?>" ><?= $cat['nama_catagory'] ?></option>
                              <?php endforeach ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="harga_beli" name="harga_beli" class="form-control col-md-7 col-xs-12 rupiah">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="harga_jual" name="harga_jual" class="form-control col-md-7 col-xs-12 rupiah">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="number" id="stok" name="stok" class="form-control col-md-7 col-xs-12 rupiah">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control has-feedback-left" id="diskon" name="diskon">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12">
                          <textarea id="keterangan"  class="form-control "  name="keterangan" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100"  data-parsley-validation-threshold="10"></textarea>                          
                        </div>
                      </div>
